...
class VehicleController(private val vehicleService: VehicleService) {
    ...
    suspend fun getAll(call: ApplicationCall) {
        try {
            ...
            val subfleetIdFilter = call.request.queryParameters["subfleetId"]?.toIntOrNull()  // ✨ NOVO
            ...
            val serviceResult = vehicleService.getAllVehicles(
                ...
                subfleetIdFilter = subfleetIdFilter  // ✨ NOVO
            )
        ...
        try {
            ...
            if (vehicleId == null) {
                call.respond(
                    ...
                    mapOf("message" to "Parâmetro obrigatório: id")
                )
                return
            }
    ...
    suspend fun getTopDriver(call: ApplicationCall) {
        try {
            ...
            val serviceResult = vehicleService.getTopDriverByVehicle(
                vehicleId = vehicleId,
                startDate = startDate,
                endDate = endDate
            )
