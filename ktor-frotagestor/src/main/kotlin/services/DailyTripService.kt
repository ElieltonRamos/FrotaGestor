...
class DailyTripService(
    ...
    suspend fun processGpsData(
        ...
        if (!ignition || odometer == null) {
            if (odometer == null) {
                println("⚠️ GPS descartado: odômetro nulo ou ignicao desligada (veículo $vehicleId)")
            }
            return
        }

        val validOdometer = odometer
    ...
    private suspend fun createDailyTrip(
        ...
        val tripId = TripsTable.insert {
            ...
            // início = ponto mais distante inicial
    ...
    private suspend fun updateDailyTrip(
        ...
        DatabaseFactory.dbQuery {
            ...
            val startOdometer = trip[TripsTable.startOdometer]!!
            ...
            val distanceCurrent =
                calculateDistance(startLat, startLon, latitude, longitude)

            val distanceStored =
                calculateDistance(startLat, startLon, currentEndLat, currentEndLon)
    ...
    private suspend fun finalizeTrip(tripId: Int) {
        DatabaseFactory.dbQuery {
            ...
            val totalDistanceKm =
                trip[TripsTable.distanceKm]?.toDouble() ?: 0.0
